...
public class verifyCartIsEmptyBeforeAddingProducts {
	...
	@Test(priority=4)
	public void verifyCartIsEmptyBeforeAddingProducts() throws InterruptedException
	{
		cp.clickOnCartButton();
		Thread.sleep(5000);
		Assert.assertTrue(cp.isCartPageEmpty());
		Thread.sleep(2000);
